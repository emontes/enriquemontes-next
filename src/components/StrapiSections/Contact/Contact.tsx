...
export default function ContactPage({Heading, Image: ImageData} : ContactProps) {
  return (
    <section className="bg-sky-50">
      <div className="flex flex-col md:flex-row">
        {ImageData?.data && (
          <div className="relative w-full md:w-1/2">
            ...
            <HeadingText
            attributes={{ id: "ContactBlock", className: "text-2xl font-bold mb-4 capitalize" }}
      ...
      <div className="bg-gray-800 text-white p-4 text-center">
        <h3 className="text-xl font-serif">Enrique Montes Araujo</h3>
      </div>
    </section>
  );
}